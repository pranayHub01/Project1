document.addEventListener("DOMContentLoaded", () => {
  ...
  const displayProducts = () => {
      ...
      const loadCount = Math.min(itemsPerLoad, filteredProducts.length - currentIndex);
      ...
      loadMoreButton.style.display = currentIndex < filteredProducts.length ? "block" : "none";
  };
